...
ReverseProxy.prototype.register = function(src, target, opts){
  ...
  // This will set on route registration a extra value that identifys the backend thats added this route.
  if(!this.opts.add_by_backend) this.opts.add_by_backend = "internal";
...
/**
  ...
  @opts {Object} Route options.
*/
ReverseProxy.prototype.get_backend = function(host, url){
